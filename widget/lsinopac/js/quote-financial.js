...
//        var that = this;
        ...
        _financial_loaddata: function() {
            ...
            this.$pageobj.loaddata("financialdata","/data/getfinancial",{
                ...
                $.each(datalist.bal_sheet, function(k,v){
                        ...
                        that.$pageobj.find(".headerrow").find(y).html(LabCI.WP.CommonRC.getRes("month",that.lang)[tmp_date.getMonth()] + ", " + tmp_date.getFullYear().toString());
        ...
        _setUILabels: function () {
            ...
            $.each(rb, function (id, value) {dt.find("." + id + " .title").html(value);});
