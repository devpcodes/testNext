...
LabCI.WP.AppUtils = {
    ...
    onReceiveFailResp: function(errcodeobj, $refobj) {
        ...
        var msg = err[errcodeobj.reasonCode]; if (msg===undefined) msg = err.defmsg;
...
<div class=\"datarow actionbtnrow\"><div class=\"actionbtn\" id=\"ok\"></div><div class=\"actionbtn\" id=\"cancel\"></div></div>\
    ...
    openAlert: function(title, msg, lang, isconfirm, onOK, onCancel, $refobj, _usebigbox) {
        ...
        if (this.$alertdialog!==undefined) {
            ...
            this.$alertdialog.remove(); this.$alertdialog = undefined;
            this.$alertdialogcurtain.remove(); this.$alertdialogcurtain = undefined;
        }
        ...
        var $ok = this.$alertdialog.find("#ok").click(function() {
            if (onOK) onOK();
            that.$alertdialog.remove(); that.$alertdialog = undefined;
            that.$alertdialogcurtain.remove(); that.$alertdialogcurtain = undefined;
        })
        .html(rb.button.ok);
...
*/    
    openQuotePage: function(symbol, exchange){
        ...
        window.open(parent.Utility.subPath +"TradingCenter_TWStocks_SubBrokerage?tab=2&symbol="+symbol+"&exch="+exchange);
...
//        if (thisopts) opts = $.extend(opts, thisopts);
        ...
        LabCI.WP.AppUtils.initactionbuttongroup(tabbox.$tabbar, {
            onchange: function(tabid, issametab) {
                ...
                tabbox.$tabbodys.filter("[tabid='"+tabid+"']").show().siblings().hide();
...
////////////////////////////////////////////////////////////////////////////
    ...
    initTRdclm: function($pageobj, lang) {
        var $trdclm = $("<a href='#' class='textlink'>" + LabCI.WP.CommonRC.getMsg("trdclm", lang) + "</a>").click(function() {
