(function ($) {
    ...
    var ADVANCED_CRITERIA_ITEMS = {
        APEEXCLXOR: {
            ...
            tooltip:
                'This ratio is calculated by dividing the latest Price Close by the Basic EPS Excluding Extraordinary Items for the latest fiscal year.',
            type: null,
            unit: 'Times',
            dp: 3,
        },
        ...
        F_DIV: {
            ...
            tooltip:
                'This is the Dividends paid per share to the primary common shareholders for the most resent fiscal year',
            type: null,
            unit: '%',
            dp: 3,
        },
        F_DIV_YIELD: {
            name: 'Dividend Yield (%)',
            tooltip:
                'This value is the calculated as the Dividends paid per share to the primary common shareholders for the most resent fiscal year divided by the latest Price Close, multiplied by 100.',
            type: null,
            unit: '%',
            dp: 3,
        },
        F_EARNING_RATIO: {
            name: 'Earning Ratio',
            tooltip:
                'This ratio is calculated by dividing the Basic EPS Excluding Extraordinary Items for the latest fiscal year by the latest Price Close.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        F_ROE: {
            ...
            tooltip:
                'This value is calculated as the Income Available to Common Stockholders for the most recent fiscal year divided by the Average Common Equity and is expressed as a percentage.',
            type: null,
            unit: '%',
            dp: 3,
        },
        F_ROA: {
            ...
            tooltip:
                'This value is calculated as the Income Available to Common Stockholders for the most recent fiscal year divided by the Total Asset and is expressed as a percentage.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        F_REV_GROWTH_RATE: {
            ...
            tooltip:
                'Revenue Growth Rate (%): Choice of Comparison Terms&#10;(Prv. Year / 3 Yrs Ago / 5 Yrs Ago / Prv. Year Same Quarter)',
            type: [
                { id: '1y', name: 'Prv.Year' },
                { id: '3y', name: '3YrsAgo' },
                { id: '5y', name: '5YrsAgo' },
        ...
        F_REV_OVERSEAS: {
            ...
            tooltip:
                '[Actual] Overseas Sales Ratio shows how much percentage overseas sales is out of consolidated sales.',
            type: null,
            unit: '%',
            dp: 3,
        },
        F_OP_MARGIN: {
            ...
            tooltip:
                'This ratio is calculated by dividing Operating Income by Revenue for the most recent fiscal year.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        F_LONG_GROWTH_RATE: {
            ...
            tooltip:
                'Ordinary Profit Growth Rate (%): Comparison Term Choice&#10;(Prv. Year / 3 Yrs Ago / 5 Yrs Ago / Prv. Year Same Quarter)',
            type: [
                { id: '1y', name: 'Prv.Year' },
                { id: '3y', name: '3YrsAgo' },
                { id: '5y', name: '5YrsAgo' },
        ...
        F_ROS_GROWTH_RATE: {
            ...
            tooltip:
                'Profit Margin On Sales (%): Comparison Term Choice&#10;(Prv. Year / 3 Yrs Ago / 5 Yrs Ago / Prv. Year Same Quarter)&#10;&#10;Profit Margin On Sales (%): Net Income / Sales X 100',
            type: [
                { id: '1y', name: 'Prv.Year' },
                { id: '3y', name: '3YrsAgo' },
                { id: '5y', name: '5YrsAgo' },
        ...
        AQUICKRATI: {
            name: 'Quick Ratio',
            tooltip:
                'This ratio is defined as Cash plus Short Term Investments plus Accounts Receivable for the most recent fiscal year divided by the Total Current Liabilities for the same period.',
            type: null,
            unit: null,
            dp: 3,
        },
        F_DIV_PAYOUT: {
            name: 'Payout Ratio (%)',
            tooltip:
                'This is the ratio of Dividends paid per share to the primary common shareholders divided by the Earning Per Shares for the most resent fiscal year.',
            type: null,
            unit: '%',
            dp: 3,
        },
        F_DEBT_ASSET_RATIO: {
            ...
            tooltip:
                'This ratio is the Total Debt for the most recent fiscal year divided by Total Assets for the same period.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        F_INT_COV_RATIO: {
            ...
            tooltip:
                'This is the ratio of Earnings Before Interest and Taxes for the most recent year divided by the Interest Expense for the same period, also known as Times Interest Earned.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        E_PER: {
            name: 'P/E (Est.)',
            tooltip:
                'This ratio is calculated by dividing the Latest Price Close by the Forecast Basic EPS Excluding Extraordinary Items.',
            type: null,
            unit: 'Times',
            dp: 3,
        },
        ...
        E_DIV_YIELD: {
            ...
            tooltip:
                'This value is calculated as the consensus estaimated dividend per share per share to the primary common shareholders for the most resent fiscal year divided by the latest Price Close, multiplied by 100.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        F_MKTCAP_USD: {
            ...
            tooltip:
                'This value is calculated by multiplying the latest Price Close by the current number of Shares Outstanding.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        E_TARGET_PRC_DEV_CHG_RATE: {
            ...
            tooltip:
                'Target Price Deviation Rate:  (Target Price - Prv. Close) / Target Price X 100  (%)&#10;Term Choice: 1 Wk Ago / 1 Mth Ago / 3 Mths Ago / 6 Mths Ago / 12 Mths Ago',
            type: [
                { id: '1w', name: '1WkAgo' },
                { id: '1m', name: '1MthAgo' },
                { id: '3m', name: '3MthsAgo' },
        ...
        E_RATING_CHG: {
            ...
            tooltip:
                'Change of Average Score by Broker Analysts(5 ratings)&#10;&#10;Term Choice: 1 Wk Ago / 1 Mth Ago / 3 Mths Ago / 6 Mths Ago / 12 Mths Ago',
            type: [
                { id: '1w', name: '1WkAgo' },
                { id: '1m', name: '1MthAgo' },
                { id: '3m', name: '3MthsAgo' },
        ...
        T_DEV_SMA: {
            ...
            tooltip:
                'SMA deviation rate is the percentage difference between the latest price close with the simple moving average.&#10;Term: 5 Biz Days / 25 Biz Days / 75 Biz Days',
            type: [
                { id: '5', name: '5 Biz Days Ago' },
        ...
        T_RSI: {
            ...
            tooltip:
                'The RSI is a momentum oscillator measuring the velocity and magnitude of directional price movements. It is calculated based on a 14-day timeframe and range between 0 and 100.',
            type: null,
            unit: null,
            dp: 3,
        },
        T_PSYCHO_LINE: {
            ...
            tooltip:
                'Psychological Line is the ratio of the number of rising periods over the total number of periods. If the ratio is above 50%, it indicates an uptrend. If it is below 50%, it indicates a downtrend.&#10;Term: 14 Biz Days',
            type: null,
            unit: null,
            dp: 3,
        },
        T_FAST_STO: {
            ...
            tooltip:
                "Fast Stochastic is a technical momentum indicator that compares a security's closing price to its price range over a given time period. In general stochastic above 80 is considered overbought and below 20 is considered oversold.&#10;Term: 14 Biz Days",
            type: null,
            unit: null,
            dp: 3,
        },
        ...
        T_BOLLINGER: {
            name: 'Bollinger (Old)',
            tooltip:
                '[Hourly] It is useful to see market turning point. Getting closer to the upper (or lower) band means over-sold (or over-bought).',
            type: null,
            unit: null,
            dp: 3,
        },
        ...
        T_GOLDX: {
            name: 'Golden Cross',
            tooltip:
                '[Hourly] Short-term moving average breaking above its long-term moving average or resistance level (Buy signal)',
            type: [
        ...
        T_MACD_BULLX: {
            ...
            tooltip:
                'A bullish signal when the MACD line crosses above the signal line. The signal line is a 9-day EMA of the MACD line.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_MACD_BEARX: {
            ...
            tooltip:
                'A bearish signal when the MACD line crosses below the signal line. The signal line is a 9-day EMA of the MACD line.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_SHORT_GOLDX: {
            ...
            tooltip:
                'Golden cross is a pattern created when a shorter term moving average crosses above a longer term moving average. This is typically seen as a bullish signal. It is based on the 5-day and 25-day SMA.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_MID_GOLDX: {
            ...
            tooltip:
                'Golden cross is a pattern created when a shorter term moving average crosses above a longer term moving average. This is typically seen as a bullish signal. It is based on the 25-day and 75-day SMA.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_SHORT_DEADX: {
            ...
            tooltip:
                'Dead cross is a pattern created when a shorter term moving average crosses below a longer term moving average. This is typically seen as a bearish signal. It is based on the 5-day and 25-day SMA.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_MID_DEADX: {
            ...
            tooltip:
                'Dead cross is a pattern created when a shorter term moving average crosses below a longer term moving average. This is typically seen as a bearish signal. It is based on the 25-day and 75-day SMA.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_BOLL_BULL: {
            ...
            tooltip:
                'Bollinger breakout occurs when stock price breaks outside of the upper Bollinger band. This is considered as a bullish trend signal.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_BOLL_BEAR: {
            ...
            tooltip:
                'Bollinger breakout occurs when stock price breaks outside of the lower Bollinger band. This is considered as a bearish trend signal.',
            type: null,
            isbool: true,
            unit: null,
            dp: 0,
        ...
        T_N225_ABOVE: {
            ...
            tooltip:
                '[Hourly] The shares above Nikkei 225 net change (Prv. Day, 5 Days Ago, 20 Days Ago, 3 Mths Ago, 6 Mths Ago, 1 Yr Ago, 3 Yrs Ago, 5 Yrs Ago)',
            type: [
                { id: '', name: 'Prv. Day' },
                { id: '5', name: '5 Biz Days Ago' },
                { id: '20', name: '20 Biz Days Ago' },
        ...
        T_N225_BELOW: {
            ...
            tooltip:
                '[Hourly] The shares below Nikkei 225 net change (Prv. Day, 5 Days Ago, 20 Days Ago, 3 Mths Ago, 6 Mths Ago, 1 Yr Ago, 3 Yrs Ago, 5 Yrs Ago)',
            type: [
                { id: '', name: 'Prv. Day' },
                { id: '5', name: '5 Biz Days Ago' },
                { id: '20', name: '20 Biz Days Ago' },
        ...
        M_N225: {
            name: 'Nikkei 225',
            tooltip:
                'Beta value of individual stocks to Nikkei 225 by calculating individual stock prices(EOD) and daily Nikkei 225(EOD) in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_LIBOR3M: {
            ...
            tooltip:
                'Correlation coefficient of individual stocks to USD 3-month LIBOR by calculating individual stock prices(EOD) and USD 3-month LIBOR(EOD).',
            type: null,
            unit: null,
            dp: 3,
        },
        M_TIBOR3M: {
            ...
            tooltip:
                'Correlation coefficient of individual stocks to JPY 3-month TIBOR by calculating individual stock prices(EOD) and JPY 3-month TIBOR(EOD).',
            type: null,
            unit: null,
            dp: 3,
        },
        M_XAU: {
            ...
            tooltip:
                'Correlation coefficient of individual stocks to gold NY spot rate by calculating individual stock prices(EOD) and gold NY spot rates(EOD) in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_JPYBOEEER: {
            ...
            tooltip:
                'Correlation coefficient of individual stocks to effective exchange rate(JPY) by calculating individual stock prices(EOD) and JPY daily effective exchange rates issued by Bank of England in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        S_OVERALL: {
            ...
            tooltip:
                'Company score-overall is an average score of 5 benchmarks (fundamentals, valuation, earnings, risk, and price momentum) marking every score from 1(lowest) to 10(highest).',
            type: null,
            unit: null,
            dp: 3,
        },
        S_FUNDAMENTAL: {
            name: 'Fundamentals',
            tooltip:
                'Fundamentals is a weighted average of 4 benchmarks (profitability, liabilities, sales, and dividends) marking every score from 1(lowest) to 10(highest). ',
            type: null,
            unit: null,
            dp: 3,
        },
        S_RELATIVE_VALUATION: {
            name: 'Valuation',
            tooltip:
                'Valuation is a weighted average in 50%, 25%, 25% of 3 benchmarks(stock price vs. sales, actual PE, estimated PE) considering for the whole market, index benchmarks, and company actual performances in the past 5 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        S_EARNINGS: {
            name: 'Earnings',
            tooltip:
                'Earnings is a weighted average of a weighted average of 3 benchmarks (earning surprise, brokers score and company estimates).',
            type: null,
            unit: null,
            dp: 3,
        },
        S_PRICE_MOMENTUM: {
            ...
            tooltip:
                'Momentum is a weighted average in 70% and 30% of 2 technical performance benchmarks (relative strength in the market and seasonal strength) from 1(lowest) to 10(highest).',
            type: null,
            unit: null,
            dp: 3,
        },
        S_RISK: {
            name: 'Risk',
            tooltip:
                'Risk is a weighted average in 40%, 30%, 20% and 10% of 4 benchmarks (volatility, return change, market beta, and index relativity) considering for the performances in long-term(5 years) and short-term(90 days) from 1(lowest) to 10(highest).',
            type: null,
            unit: null,
            dp: 3,
        },
        ...
        M_USDBOEEER: {
            ...
            tooltip:
                'A relative coefficient of individual stocks to USD effective exchange rate based on daily USD effective exchange rate.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_VIX: {
            ...
            tooltip:
                'VIX(Volatility Index). A relative coefficient of individual stocks to VIX based on end of the day stock prices and VIX in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_CRB: {
            ...
            tooltip:
                'A relative coefficient of individual stocks to CRB index based on end of the day stock prices and CRB in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_NKC1: {
            ...
            tooltip:
                'A relative coefficient of individual stocks to Nikkei 225 on US Dollar basis based on end of the day stock prices and Nikkei 225 on US Dollar basis in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_CLC1: {
            ...
            tooltip:
                'A relative coefficient of individual stocks to WTI Crude Oil price based on end of the day stock prices and NWTI Crude Oil price in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_TOPX: {
            name: 'TOPIX',
            tooltip:
                'A stock index beta value of individual stocks to TOPIX based on end of day stock prices and TOPIX in the past 2 years.',
            type: null,
            unit: null,
            dp: 3,
        },
        M_TSE33: {
            ...
            tooltip:
                '[EOD] It presents response of the stock prices to the market movements in the past 2 years vs. TSE33 sector index.',
            type: null,
            unit: null,
            dp: 3,
        },
        T_DMI: {
            ...
            tooltip:
                'DMI (Directional Movement Indicator) is an indicator which tells whether an instrument is trending or not ranged from 0 to 100.&#10;Term: 14 Biz Days',
            type: null,
            unit: null,
            dp: 0,
        },
        ...
        T_MACD_: {
            name: 'MACD',
            tooltip:
                '[Hourly] MACD rises above signal line(Golden Cross) that may be a good time to buy. &#10;&#10;[Hourly] MACD falls below signal line(Dead Cross) that may be a good time to sell.',
            type: [
        ...
        P2BEpsIEx_CurA: {
            ...
            tooltip:
                'This ratio is calculated by dividing the Latest Price Close by the Basic EPS Including Extraordinary Items for the latest fiscal year.',
            type: null,
            unit: null,
            dp: 3,
        },
        ...
        FLOAT: {
            name: 'Float',
            tooltip:
                'This is the number of freely traded shares in the hands of the public. Float is calculated as Shares Outstanding minus Shares Owned by Insiders, 5% Owners, and Rule 144 Shares. NOTE: For the first year after an initial public offering (IPO) the float will be the number of shares issued in the IPO.',
            type: null,
            unit: null,
            dp: 0,
        },
        ...
        DVOLSHSOUT: {
            ...
            tooltip:
                'This is the Average Daily Volume divided by the most recent Shares Outstanding, multiplied by 100.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        PR5DAYPRC: {
            ...
            tooltip:
                "The 5 Day Price Percent Change is the percentage change in the company's stock price over the last 5 tradable (business) days.  If the issue did not trade at the beginning of this period, the the latest price prior to 5 days ago will be used.",
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        PR52WKPCT: {
            ...
            tooltip:
                'This is the percentage change in price over the last fifty two weeks as compared to the change in price of the S&P 500 during that same period.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        VOL1DAVG: {
            ...
            tooltip:
                'This is the daily volume average calculated by dividing the cumulative trading volume of the last 91 days by the number of trading days during this period.',
            type: null,
            unit: null,
            dp: 3,
        },
        ChPctPriceWTD: {
            ...
            tooltip:
                'This is the percentage change between the most recent market closing price and the closing price at the week start. Week start price is the closing price of the previous week.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ChPctPriceMTD: {
            ...
            tooltip:
                'This is the percentage change between the most recent market closing price and the closing price at the month start. Month start price is the closing price of the previous month.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ChPctPriceQTD: {
            ...
            tooltip:
                'This is the percentage change between the most recent market closing price and the closing price at the quarter start. Quarter start price is the closing price of the previous calendar quarter.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        ALTD2AST: {
            ...
            tooltip:
                'This ratio is the Total Long Term Debt for the most recent fiscal year divided by the Total Assets for same period.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        AEBITDMG: {
            name: 'EBITD Margin (%)',
            tooltip:
                'This value represents annual Earnings Before Interest, Taxes and Depreciation expressed as a percent of annual Total Revenue. NOTE: This value is only available for Industrial and Utility companies.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        ALTDPS: {
            ...
            tooltip:
                'This is the Total Long Term Debt at the end of the fiscal year divided by the Shares Outstanding at the end of the same period.',
            type: null,
            unit: null,
            dp: 3,
        },
        ...
        ATACHG: {
            ...
            tooltip:
                'This is the percent change in most recent annual period total asset as compared to the same period one year ago.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        ANLOANCHG: {
            ...
            tooltip:
                'This is the percent change in most recent annual period total Bank Loans as compared to the same period one year ago.',
            type: null,
            unit: '%',
            dp: 3,
        },
        ...
        ANICHG: {
            ...
            tooltip:
                'This value is the most recent year Income After Taxes minus the Income After Taxes for the preceding year divided by the Income After Taxes for the preceding year, multiplied by 100.',
            type: null,
            unit: '%',
            dp: 3,
        },
    ...
    LabCI.WP.ScreenerPageObj = {
        ...
        recperpage: 25,
        subcat1:
            'm:23415,a:1|0|0,s:5130531055105110532053305620501054105550561055605230521052205530512054205540502053405430572057105810524050305910',
        subcat2: 'ticker',
        subcat3: 'asc',
        ...
        initImpl: function () {
            ...
            $.each(this.sectorlist, function (index, data) {
                if (index % 4 == 0) {
                    var element =
                        ...
                        '<div class="col pr-0">' +
                        '<div class="sectorbox selected" sector="' +
                        that.sectorlist[index] +
                        '"><div class="sectorbox-header lbl' +
                        that.sectorlist[index] +
                        '">1</div><div class="sectorbox-body"><span class="sectorbox-count count' +
                        that.sectorlist[index] +
                        '">0</span><span class="lblsectorbox-count"> stock(s)</span></div></div>' +
                        '</div>' +
                        '<div class="col pr-md-0">';
                    if (index + 1 < that.sectorlist.length) {
                        element +=
                            '<div class="sectorbox selected" sector="' +
                            that.sectorlist[index + 1] +
                            '"><div class="sectorbox-header lbl' +
                            that.sectorlist[index + 1] +
                            '">2</div><div class="sectorbox-body"><span class="sectorbox-count count' +
                            that.sectorlist[index + 1] +
                            '">0</span><span class="lblsectorbox-count"> stock(s)</span></div></div>';
                    }
                    ...
                    if (index + 2 < that.sectorlist.length) {
                        element +=
                            '<div class="sectorbox selected" sector="' +
                            that.sectorlist[index + 2] +
                            '"><div class="sectorbox-header lbl' +
                            that.sectorlist[index + 2] +
                            '">3</div><div class="sectorbox-body"><span class="sectorbox-count count' +
                            that.sectorlist[index + 2] +
                            '">0</span><span class="lblsectorbox-count"> stock(s)</span></div></div>';
                    }

                    element += '</div>' + '<div class="col pr-md-0">';
                    if (index + 3 < that.sectorlist.length) {
                        element +=
                            '<div class="sectorbox selected" sector="' +
                            that.sectorlist[index + 3] +
                            '"><div class="sectorbox-header lbl' +
                            that.sectorlist[index + 3] +
                            '">4</div><div class="sectorbox-body"><span class="sectorbox-count count' +
                            that.sectorlist[index + 3] +
                            '">0</span><span class="lblsectorbox-count"> stock(s)</span></div></div>';
                    }
            ...
            $.each(this.advancedCriteria, function (index, data) {
                ...
                for (var key in data) {
                    var element =
                        '<div class="advanced-selection-subtitle">' +
                        that.pageobj_rb.lbl['criteriatype_' + key] +
                        '</div>';

                    var criteriaArray = data[key];
                    for (var cKey in criteriaArray) {
                        element +=
                            '<div class="advanced-selection-item lbl' +
                            criteriaArray[cKey] +
                            '" item="' +
                            criteriaArray[cKey] +
                            '">' +
                            that.pageobj_rb.lbl['criteria_' + criteriaArray[cKey]] +
                            '</div>';
                    }
                    $(col).append(element);
                }
                    ...
                    if (criteriaArray[i].indexOf('s:') >= 0) {
                        ...
                        if (sectors != '') {
                            ...
                            for (var j = 0; j < sectorsArray.length; ++j) {
                                that.$sectorselection
                                    .find(".sectorbox[sector='" + sectorsArray[j] + "']")
                                    .addClass('selected');
                            }
                        }
                    }
            ...
            $('#saveModel').on('show.bs.modal', function (event) {
                ...
                for (var i = 0; i < that.savedStrategy.length; ++i) {
                    that.$pageobj
                        .find(".strategy-save-dropdown button[value='" + i + "']")
                        .html(that.savedStrategy[i].name);
                }
            });
        ...
        _loadSavedStrategy: function () {
            ...
            if (localStorage['lsinopac_screener_strategy']) {
                ...
                this.savedStrategy = [
                    {
                        name: this.pageobj_rb.lbl['strategy0'],
                        subcat1: this.subcat1,
                        subcat2: this.subcat2,
                        subcat3: this.subcat3,
                        used: '0',
                    },
                    {
                        name: this.pageobj_rb.lbl['strategy1'],
                        subcat1: this.subcat1,
                        subcat2: this.subcat2,
                        subcat3: this.subcat3,
                        used: '0',
                    ...
                    {
                        name: this.pageobj_rb.lbl['strategy2'],
                        subcat1: this.subcat1,
                        subcat2: this.subcat2,
                        subcat3: this.subcat3,
                        used: '0',
                    ...
                    {
                        name: this.pageobj_rb.lbl['strategy3'],
                        subcat1: this.subcat1,
                        subcat2: this.subcat2,
                        subcat3: this.subcat3,
                        used: '0',
            ...
            this.$pageobj
                .find('.saved-dropdown')
                .append(
                    '<button class="dropdown-item savedlabel" value="saved" type="button" strategy="">' +
                        this.pageobj_rb.lbl['savedstrategy'] +
                        '</button>',
                );
        ...
        _prepareAdvancedCriteriaItemBoxHtml: function (acid, idx) {
            ...
            // The leading part
            var html =
                '<div class="advancedcriteriaitembox ca' +
                acid +
                '" idx="' +
                idx +
                '" id="ca' +
                ...
                "<div class=\"col-11 p-0 m-0 name hyperlink\" data-toggle='modal' data-target='#advancedModel' data-advanced='" +
                idx +
                "'>" +
                this.pageobj_rb.lbl['criteria_' + acid] +
                '</div><div class="col-1 p-0 m-0 delbutton" onclick="window[\'lsinopac_screener\']._removeAdvancedCriteria(' +
                idx +
                ', true)"></div></div>';
            ...
            if (ac.type) {
                ...
                $.each(ac.type, function (index, value) {
                    html +=
                        ...
                        value.id +
                        '"' +
                        (value.isdef == true ? ' selected' : '') +
                        '>' +
                        that.pageobj_rb.lbl[value.name] +
                        '</option>';
                });
            ...
            // If not, then, show the histogram slider, if this is no a boolean criteria?
                ...
                html +=
                    '<div class="sliderrow" style=\'padding-top:10px\'><table cellspacing="0" cellpadding="0" border="0" style=\'width: 100%\'><tr class="inputrow"><td style="text-align:left !important;padding-left:10px;width:45%"><input type="text" maxlength="16" value="" class="ca' +
                    acid +
                    '_from" style=\'width: 100%;\'></td><td style="width:10%;">〜</td><td style="text-align:right !important;padding-right:10px;width:45%"><input type="text" maxlength="16" value="" class="ca' +
                    acid +
                    '_to" style=\'width: 100%;\'></td></tr><tr class="labelrow"><td class=\'label\' style="text-align:left !important;padding-top:5px;padding-left:10px">' +
                    this.pageobj_rb.lbl['min'] +
                    '</td><td></td><td class=\'label\' style="text-align:right !important;padding-top:5px;padding-right:10px">' +
                    this.pageobj_rb.lbl['max'] +
                    '</td></tr></table></div><div class="histogramslider"><div id="ca' +
                    acid +
                    '-' +
                    idx +
                    '" class="imagepane"></div><div class="slidercontrol"></div></div>';
            }
            ...
            if (itemboxobj.length > 0) {
                ...
                if (preset) {
                    ...
                    if (ac.type) {
                        ...
                        if (_typeobj.length > 0) _typeobj[0].selected = true;
                    ...
                    if (ac.isfixedrange) {
                        ...
                        if (_fixedrangefromobj.length > 0) _fixedrangefromobj[0].selected = true;

                        var _fixedrangetoobj = itemboxobj.find('.ca' + acid + '_range_to #' + preset.to);
                        if (_fixedrangetoobj.length > 0) _fixedrangetoobj[0].selected = true;
                    }
                }
                ...
                slide: function (event, ui) {
                    ...
                    that.$slidertimeout = setTimeout(function () {
                        ...
                        if (result) {
                            ...
                            var isfromslided;
                            if (ui.value == ui.values[0]) isfromslided = true;
                            else isfromslided = false;
                            ...
                            if (isfromslided) _fromvalobj.val(curmin.toFixed(dp));
                            else _tovalobj.val(curmax.toFixed(dp));
        ...
        _loadCriteriaHistogramChart: function (acid, idx, loadResult) {
            ...
            if (_selectobj.length > 0) typeid = _selectobj[0][_selectobj[0].selectedIndex].id;
            ...
            if (presetfrom != null) itemboxobj.find('.ca' + acid + '_from').val(presetfrom);
            if (presetto != null) itemboxobj.find('.ca' + acid + '_to').val(presetto);
            ...
            this.$pageobj.loaddata(
                'screener_advanced_criteria_' + acid,
                '/data/widget_screener_criteria_advanced',
                {
                    id: acid,
                    type: typeid,
                ...
                function (data) {
                    ...
                    if (data.data.datalist && data) {
                        var _chartobj = that._generateAdvancedCriteriaHistorgramChart(
                            itemboxobj,
                            result.datalist,
                            $.data(_scobj[0], 'chartobj'),
                            acid,
                            typeid,
                        );
                        ...
                        if (presetfrom != null && presetfrom != -99999999) curmin = presetfrom; // just set, ignoring the boundary
                        //if ((presetto != null) && (presetto != 9999999) && (presetto < curmax)) curmax = presetto;
                        if (presetto != null && presetto != 99999999) curmax = presetto; // just set, ignoring the boundary
        ...
        _generateAdvancedCriteriaHistorgramChart: function (itemboxobj, datalist, chartobj, acid, typeid) {
            ...
            if (!_chartobj) {
                imagepaneobj.html(
                    "<img class='histogramchartimg' style='width:100%' src='" +
                        APP_CONFIG.DataAPIPath +
                        '/data/widget_screener_criteria_advanced_chart?id=' +
                        acid +
                        '&type=' +
                        typeid +
                        '&token=' +
        ...
        _removeAdvancedCriteria: function (idx, loadResult) {
            this.$advancedselectionBox
                .find('.advancedbox.advanced' + idx)
                .html(
                    "<div class='no_criteria' data-toggle='modal' data-target='#advancedModel' data-advanced='" +
                        idx +
                        "'>+ Criteria</div>",
                );
            if (loadResult) {
                ...
                function (result) {
                    if (result && result.data && result.data.responseCode !== 'F') {
                        ...
                        $.each(that.$sectorselection.find('.sectorbox'), function (index, data) {
                            ...
                            $(this)
                                .find('.count' + sectorCode)
                                .setValue(addCommaSeparators(result.data.datalist['a' + sectorCode]));
                        });
                        ...
                        if (that.$screenerlist.is(':visible')) {
                            ...
                            if (result.data.datalist.datalist && result.data.datalist.datalist.length > 0) {
                                ...
                                if (result.data.datalist.adv_nm) {
                                    for (var i in result.data.datalist.adv_nm) {
                                        ...
                                        that.$screenerlist
                                            .find('thead tr')
                                            .append(
                                                "<td class='adv text-right' style='cursor: pointer' item='adv" +
                                                    i +
                                                    "' onclick=\"window['lsinopac_screener']._sortResult(this)\"><span class='lbl" +
                                                    adv +
                                                    "'>" +
                                                    that.pageobj_rb.lbl['criteria_' + adv] +
                                                    '</span></td>',
                                            );
                                    }
                                }
                                ...
                                if (order == 'asc') {
                                    that.$screenerlist
                                        .find("td[item='" + sort + "']")
                                        .append('<arrow-placeholder class="arrow-up"></arrow-placeholder>');
                                } else {
                                    that.$screenerlist
                                        .find("td[item='" + sort + "']")
                                        .append('<arrow-placeholder class="arrow-down"></arrow-placeholder>');
                                }
                                ...
                                for (var key in result.data.datalist.datalist) {
                                    ...
                                    var addedRow =
                                        "<tr class='datalist' style='cursor:pointer' ric='" +
                                        result.data.datalist.datalist[key].info.ric +
                                        "' symbol='" +
                                        result.data.datalist.datalist[key].info.symbol +
                                        "' exchange='" +
                                        LabCI.WP.AppUtils.INTEGRATION_EXCHANGE_MAPPING[
                                            result.data.datalist.datalist[key].info.exchsect
                                        ] +
                                        "'><td>" +
                                        result.data.datalist.datalist[key].info.symbol +
                                        '</td>' +
                                        '<td>' +
                                        result.data.datalist.datalist[key].info.nm +
                                        '</td>' +
                                        '<td>' +
                                        that.pageobj_rb.lbl[result.data.datalist.datalist[key].info.exchsect] +
                                        '</td>' +
                                        "<td class='text-right'>" +
                                        result.data.datalist.datalist[key].ls +
                                        '</td>' +
                                        "<td class='" +
                                        updownclass +
                                        " text-right'>" +
                                        setValue(
                                            result.data.datalist.datalist[key].nc,
                                            null,
                                            false,
                                            result.data.datalist.datalist[key].ls,
                                        ) +
                                        ...
                                        " text-right'>" +
                                        setValue(
                                            result.data.datalist.datalist[key].pc,
                                            '%',
                                            false,
                                            result.data.datalist.datalist[key].ls,
                                        ) +
                                ...
                                for (var i = paginationFrom; i <= paginationTo; ++i) {
                                    if (i == pageno) {
                                        pagination
                                            .find("li[item='next']")
                                            .before(
                                                '<li class="page-item page-no active" item="' +
                                                    pageno +
                                        ...
                                        pagination
                                            .find("li[item='next']")
                                            .before(
                                                '<li class="page-item page-no" item="' +
                                                    i +
                                                    '"><span class="page-link" pn="' +
                                                    i +
                                                    '" onclick="window[\'lsinopac_screener\']._loadPage(this)">' +
                                                    i +
                                                    '</span></li>',
                                            );
                                    }
                            ...
                            if (result.data.datalist.datalist && result.data.datalist.datalist.length > 0) {
                                ...
                                for (var key in result.data.datalist.datalist) {
                                    ...
                                    var addedRow =
                                        ...
                                        '">' +
                                        '<div class="row"><div class="col name">' +
                                        result.data.datalist.datalist[key].info.nm +
                                        '</div><div class="col text-right code">' +
                                        result.data.datalist.datalist[key].info.symbol +
                                        '</div></div>' +
                                        '<div class="row"><div class="col lblexchange">' +
                                        that.pageobj_rb.lbl['exchange'] +
                                        '</div><div class="col text-right exch">' +
                                        that.pageobj_rb.lbl[result.data.datalist.datalist[key].info.exchsect] +
                                        '</div></div>' +
                                        '<div class="row"><div class="col lbllast">' +
                                        that.pageobj_rb.lbl['last'] +
                                        '</div><div class="col text-right last">' +
                                        result.data.datalist.datalist[key].ls +
                                        '</div></div>' +
                                        '<div class="row"><div class="col lblchange">' +
                                        that.pageobj_rb.lbl['change'] +
                                        '</div><div class="col ' +
                                        updownclass +
                                        ' text-right change">' +
                                        setValue(result.data.datalist.datalist[key].nc, null, true) +
                                        ' (' +
                                        setValue(result.data.datalist.datalist[key].pc, '%', true) +
                                        ')' +
                                        '</div></div>';
                                    if (result.data.datalist.adv_nm) {
                                        for (var i in result.data.datalist.adv_nm) {
                                            ...
                                            addedRow +=
                                                '<div class="row"><div class="col lbl' +
                                                adv +
                                                '">' +
                                                that.pageobj_rb.lbl['criteria_' + adv] +
                                                '</div><div class="col text-right adv' +
                                                adv +
                                                '">' +
                                                val +
                                                '</div></div>';
