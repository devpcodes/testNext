                ...
                a.prototype._updateImpl.call(this),
                    ...
                    this._source.points().length < 2 ||
                        ...
                        this._source.properties().showPriceRange.value() &&
                            ...
                            (p = d / e.price),
                            (l =
                                this._source.priceScale().formatter().format(d) + ' (' + new c().format(100 * p) + ')'),
    ...
    1165: function (e, t, i) {
        ...
        inherit(n, s),
            ...
            (n.prototype.renderer = function () {
                ...
                if ((this._invalidated && (this.updateImpl(), (this._invalidated = !1)), this._points.length < 2))
                    return null;
                for (
                    e = this._source.properties(),
                        t = new h(),
        ...
        (n.prototype.setData = function (e) {
            ...
            (r.prototype.updateImpl = function () {
                ...
                if ((o.prototype._updateImpl.call(this), this._source.points().length > 0)) {
                    ...
                    t.isPercent() &&
                        ((i = this._source.ownerSource().firstValue()), (e = t.priceRange().convertToPercent(e, i))),
        ...
        (n.prototype.setData = function (e) {
            ...
            (n.prototype.draw = function (e) {
                ...
                null === this._data ||
                    ...
                    (c = !1),
                    0 !== i &&
                        (this._drawBody(e, l, d), this._drawMovePoints(e, l, d), this._drawBodyText(e, l, d), (c = !0)),
