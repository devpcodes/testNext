                ...
                (r = function (e, t) {
                    ...
                    (r.data = function (e, t, a) {
                        ...
                        if (void 0 === a) {
                            ...
                            return (
                                (s = e[r.expando] || (e[r.expando] = ++r.uuid)), (n[s] = n[s] || {}), (n[s][t] = a), a
                            );
                    }),
                        ...
                        : ((m = 400),
                                      ...
                                      if (P <= 8) f = g.css(e, r);
                                          ...
                                          if (
                                              ...
                                              if (
                                                  'height' === r &&
                                                  'border-box' !==
                                                      ('' + v.getPropertyValue(e, 'boxSizing')).toLowerCase()
                                              )
                                                  return (
                                                      (u =
                                                          e.offsetHeight -
                                                          (parseFloat(v.getPropertyValue(e, 'borderTopWidth')) || 0) -
                                                          (parseFloat(v.getPropertyValue(e, 'borderBottomWidth')) ||
                                                              0) -
                          ...
                          (x = function () {
                              ...
                              if (
                                  ...
                                  return void (
                                      k.promise && (S && P && !1 === P.promiseRejectEmpty ? k.resolver() : k.rejecter())
                                  );
                              if (
                                  ((V = w.length),
                                  (T = 0),
