            ...
            return (
                (e.prototype.subscribeBars = function (e, t, r, s) {
                    this._subscribers.hasOwnProperty(s)
                        ...
                        : ((this._subscribers[s] = { lastBarTime: null, listener: r, resolution: t, symbolInfo: e }),
        ...
        return (
            ...
            (e.prototype.searchSymbols = function (t, e, r, s) {
                if (this._configuration.supports_search) {
                    ...
                    this._send('search', o)
                        .then(function (e) {
                            if (void 0 !== e.s)
                                return n('UdfCompatibleDatafeed: search symbols error=' + e.errmsg), void s([]);
                            s(e);
                        })
                        .catch(function (e) {
            ...
            (e.prototype._requestConfiguration = function () {
                return this._send('config').catch(function (e) {
                    return (
                        n('UdfCompatibleDatafeed: Cannot get datafeed configuration - use default, error=' + c(e)), null
                    );
                });
            }),
            ...
            (e.prototype._setupWithConfiguration = function (e) {
                ...
                (!e.supports_group_request && e.supports_search) ||
                    (this._symbolsStorage = new t(this._datafeedURL, e.supported_resolutions || [], this._requester)),
