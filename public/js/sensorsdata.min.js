    ...
    try {
                        ...
                        case 'object':
                            ...
                            if (rep && 'object' == typeof rep)
                                for (a = rep.length, r = 0; r < a; r += 1)
                                    'string' == typeof rep[r] &&
                                        ((s = rep[r]), (n = str(s, c)), n && i.push(quote(s) + (gap ? ': ' : ':') + n));
                            else
                                for (s in c)
                                    Object.prototype.hasOwnProperty.call(c, s) &&
                                        ((n = str(s, c)), n && i.push(quote(s) + (gap ? ': ' : ':') + n));
                            return (
                                (n =
                                    0 === i.length
                                        ? '{}'
                                ...
                                if (n && 'object' == typeof n)
                                    for (r in n)
                                        Object.prototype.hasOwnProperty.call(n, r) &&
                                            ((s = walk(n, r)), void 0 !== s ? (n[r] = s) : delete n[r]);
        ...
        !(function () {
            ...
            (_.extend = function (e) {
                ...
                (_.extend2Lev = function (e) {
                    return (
                        u(s.call(arguments, 1), function (t) {
                            for (var r in t)
                                void 0 !== t[r] &&
                                    (_.isObject(t[r]) && _.isObject(e[r]) ? _.extend(e[r], t[r]) : (e[r] = t[r]));
                        }),
                        e
                    );
                }),
                        ...
                        return (
                            ...
                            d <= 0 || d > t
                                ? (i && (clearTimeout(i), (i = null)),
                                  ...
                                  (a = e.apply(s, n)),
                                  i || (s = n = null))
                                : i || r.trailing === !1 || (i = setTimeout(c, d)),
                            a
                        );
                    };
                }),
                ...
                (_.base64Encode = function (e) {
                    ...
                    do
                        (t = e.charCodeAt(d++)),
                            ...
                            (i = (c >> 6) & 63),
                            (o = 63 & c),
                            (f[l++] = u.charAt(n) + u.charAt(a) + u.charAt(i) + u.charAt(o));
                    while (d < e.length);
                ...
                (_.getQueryParam = function (e, t) {
                    ...
                    return null === n || (n && 'string' != typeof n[1] && n[1].length)
                        ? ''
                        : _.decodeURIComponent(n[1]).replace(/\+/g, ' ');
                }),
                ...
                (_.ry.init.prototype = {
                    ...
                    getCssStyle: function (e) {
                        ...
                        var r = null;
                        if (
                            ('function' == typeof window.getMatchedCSSRules && (r = getMatchedCSSRules(this.ele)),
                            !r || !_.isArray(r))
                        )
                            return null;
                ...
                (_.info = {
                    ...
                    campaignParamsStandard: function (e, t) {
                        ...
                        var r = _.info.campaignParams(),
                            ...
                            n = {};
                        for (var a in r)
                            (' ' + sd.source_channel_standard + ' ').indexOf(' ' + a + ' ') !== -1
                                ? (s[e + a] = r[a])
                                : (n[t + a] = r[a]);
            ...
            (sd.addReferrerHost = function (e) {
                ...
                _.isObject(e.properties) &&
                    (e.properties.$first_referrer &&
                        (e.properties.$first_referrer_host = _.getHostname(e.properties.$first_referrer, t)),
                    'track' === e.type &&
                        (e.properties.$referrer &&
                            '$pageview' === e.event &&
                            (e.properties.$referrer_host = _.getHostname(e.properties.$referrer, t)),
                        sd.para.is_track_latest.referrer &&
                            sd.para.is_track_latest.referrer_host &&
                            (e.properties.$latest_referrer_host = _.getHostname(e.properties.$latest_referrer, t))));
            }),
            (sd.initPara = function (e) {
                ...
                _.localStorage.isSupport() && _.isSupportCors() && 'object' == typeof localStorage
                    ? sd.para.batch_send === !0
                        ? ((sd.para.batch_send = _.extend({}, r)), (sd.para.use_client_time = !0))
                        : 'object' == typeof sd.para.batch_send &&
                          ((sd.para.use_client_time = !0), (sd.para.batch_send = _.extend({}, r, sd.para.batch_send)))
                ...
                if (
                    ('object' == typeof sd.para.source_type &&
                        ...
                        (sd.para.source_type.social = _.isArray(sd.para.source_type.social)
                            ? sd.para.source_type.social.concat(a)
                            : a),
                        (sd.para.source_type.keyword = _.isObject(sd.para.source_type.keyword)
                            ? _.extend(i, sd.para.source_type.keyword)
                            : i)),
                ...
                'string' == typeof sd.para.server_url &&
                    ...
                    _.isObject(sd.para.is_track_latest)
            ...
            (sd.setInitVar = function () {
                (sd._t = sd._t || 1 * new Date()),
                    (sd.lib_version = '1.14.8'),
                    (sd.is_first_visitor = !1),
                    (sd.source_channel_standard = 'utm_source utm_medium utm_campaign utm_content utm_term');
            }),
            (sd.log = function () {
                if (
                    ((_.sessionStorage.isSupport() && 'true' === sessionStorage.getItem('sensorsdata_jssdk_debug')) ||
                        sd.para.show_log) &&
                    ((sd.para.show_log !== !0 && 'string' !== sd.para.show_log && sd.para.show_log !== !1) ||
            ...
            autoTrackSinglePage: function (e, t) {
                function r() {
                    var e = _.info.campaignParams(),
                        t = {};
                    for (var r in e)
                        (' ' + sd.source_channel_standard + ' ').indexOf(' ' + r + ' ') !== -1
                            ? (t['$' + r] = e[r])
                            : (t[r] = e[r]);
                    return t;
                }
                function s(e, t) {
                    sd.track(
                        '$pageview',
                        _.extend(
                            { $referrer: n, $url: location.href, $url_path: location.pathname, $title: document.title },
                            e,
                            r(),
                        ),
                        t,
        ...
        (sd.quick = function () {
            ...
            (sd.logout = function (e) {
                ...
                t
                    ? (store.set('first_id', ''),
                      e === !0 ? store.set('distinct_id', _.UUID()) : store.set('distinct_id', t))
            ...
            (BatchSend.prototype = {
                ...
                readStore: function () {
                    for (
                        var e = [], t = [], r = null, s = new Date().getTime(), n = localStorage.length, a = 0;
                        a < n;
                        a++
                    ) {
        ...
        (dataSend.getSendUrl = function (e, t) {
            ...
            (dataSend.getSendType = function (e) {
                var t = ['image', 'ajax', 'beacon'],
                    r = t[0];
                return (
                    (r = e.config && _.indexOf(t, e.config.send_type) > -1 ? e.config.send_type : sd.para.send_type),
        ...
        (sd.sendState = sendState),
            ...
            (sendState.getSendCall = function (e, t, r) {
                ...
                if (
                    ...
                    !sd.para.use_app_track && sd.para.batch_send && localStorage.length < 200)
                )
                ...
                if (sd.para.use_app_track === !0 || 'only' === sd.para.use_app_track)
                    if (
                        ...
                        sd.para.use_app_track === !0 &&
                            (sd.debug.apph5({ data: s, step: '2', output: 'all' }), this.prepareServerUrl());
                    else {
                        var n = null;
                    ...
                    'mui' === sd.para.use_app_track
                        ...
                        : (sd.debug.apph5({ data: s, step: '1', output: 'code' }), this.prepareServerUrl());
                sd.log(s);
            }),
            ...
            (sendState.sendCall = function (e, t) {
                ...
                _.isObject(sd.para.jsapp) && !sd.para.jsapp.isOnline && 'function' == typeof sd.para.jsapp.setData
        ...
        (saEvent.checkOption = {
            ...
            (saEvent.send = function (e, t) {
                ...
                _.isObject(e) &&
                    ...
                    ((r.lib.$lib_detail = e.properties.$lib_detail), delete e.properties.$lib_detail),
                    _.extend(r, e),
            ...
            (saEvent.debugPath = function (e, t) {
                ...
                (s =
                    sd.para.debug_mode_url.indexOf('?') !== -1
                        ? sd.para.debug_mode_url + '&data=' + encodeURIComponent(_.base64Encode(e))
                        : sd.para.debug_mode_url + '?data=' + encodeURIComponent(_.base64Encode(e))),
                    _.ajax({
                        url: s,
                        type: 'GET',
        ...
        var store = (sd.store = {
                            ...
                            if ('object' == typeof t.props) {
                                for (var r in t.props)
                                    'string' == typeof t.props[r] &&
                                        (t.props[r] = t.props[r].slice(0, sd.para.max_referrer_string_length));
                                this.save();
                            }
                ...
                init: function () {
                    ...
                    null === t
                        ...
                        : ((_.isJSONString(t) && JSON.parse(t).distinct_id) || (sd.is_first_visitor = !0),
                          this.toState(t)),
            ...
            saNewUser = {
                checkIsAddSign: function (e) {
                    'track' === e.type &&
                        (_.cookie.getNewUser() ? (e.properties.$is_first_day = !0) : (e.properties.$is_first_day = !1));
                },
                ...
                checkIsFirstLatest: function () {
                    ...
                    if (
                        ('' === e && (e = 'url\u89e3\u6790\u5931\u8d25'),
                        _.each(sd.para.is_track_latest, function (t, r) {
                            if (t) {
                                if ('utm' !== r && 'url\u89e3\u6790\u5931\u8d25' === e)
                                ...
                                for (var s in sd.store._state.props)
                                    (0 === s.indexOf('$latest_utm') && 0 === s.indexOf('_latest_')) ||
            ...
            heatmap = (sd.heatmap = {
                ...
                selector: function (e) {
                    ...
                    return e.getAttribute &&
                        e.getAttribute('id') &&
                        (!sd.para.heatmap || (sd.para.heatmap && 'not_use_id' !== sd.para.heatmap.element_selector))
                        ? '#' + e.getAttribute('id')
                ...
                getDomSelector: function (e, t) {
                    ...
                    return e && 'body' !== r && 1 == e.nodeType
                        ? (t.unshift(this.selector(e)),
                          e.getAttribute && e.getAttribute('id') ? t.join(' > ') : this.getDomSelector(e.parentNode, t))
                        ...
                        t = e({
                            ...
                            func: function (e, t) {
                                ...
                                ((n > sd.para.heatmap.scroll_delay_time && r - e.$viewport_position !== 0) || t) &&
                                    ...
                                    (e.event_duration = parseInt(n) / 1e3),
                                    sd.track('$WebStay', e)),
                                    (this.current_time = s);
                            },
                        });
                        ...
                        void ('all' === sd.para.heatmap.collect_elements
                            ...
                            : _.addEvent(document, 'click', function (t) {
                                  ...
                                  if ('a' === n || 'button' === n || 'input' === n || 'textarea' === n)
                                      e.start(r, s, n);
                                  else if ('button' === a.tagName.toLowerCase() || 'a' === a.tagName.toLowerCase())
                                      ...
                                      e.start(r, _.ry(a).prev(), _.ry(a).prev().tagName.toLowerCase());
                                  else {
                        ...
                        ? (heatmap.setNotice(n),
                          _.sessionStorage.isSupport() &&
                              (n &&
                                  n[0] &&
                                  n[1] &&
                                  sessionStorage.setItem('sensors_heatmap_url', decodeURIComponent(n[1])),
                              sessionStorage.setItem('sensors_heatmap_id', r[1]),
                              s && s[0] && s[1]
                                  ? '1' === s[1] || '2' === s[1] || '3' === s[1]
                                      ? ((s = s[1]), sessionStorage.setItem('sensors_heatmap_type', s))
                                      : (s = null)
                                  : (s =
