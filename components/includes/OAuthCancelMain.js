       ...
       return (
        <>
            ...
            .btn_r {
                ...
                border-radius: 2px;min-width: 86px;
                line-height: 40px;
            ...
            @media(max-width:768px){
                ...
                .btn_r {line-height: 2; min-width: 50px;}
            ...
            .ant-modal-title img{display:none}
            .ant-modal-title span{font-size: 20px;
                line-height: 1.7;}
            .confirm__container .ant-modal-header{background-color: #ffffff;}
            .confirm__container .ant-modal-body{color:#6c7b94;font-size:16px;}
            .ant-btn.ant-btn-primary{background:#c43826}
            `}</style>
        </>
    );
};
