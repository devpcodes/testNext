...
const QaCollapse = ({ dataSource }) => {
    ...
    return (
        <div className="qaBox" id="loanIndex">
            ...
            .forMB{display:none;}
            .pagTag{position: absolute;top: -5em;}
        ...
        @media screen and (max-width: 425px) {
            ...
            <style jsx global>
                ...
                #loanIndex__container .plusIcon{ border-radius:2px; right: 0; left:auto!important;
                background:#a9b6cb; text-align:center;
                width: 26px;
                height: 26px;
                display: inline-block;}
                #loanIndex__container .plusIcon i{display: block;
