...
import QuestionSearchHeader from '../../components/includes/customerSupport/QuestionSearchHeader';
import { getCommonQuestionCategories } from '../../services/components/customerSupport/customerSupportService';
import ShortcutFunction from '../../components/includes/customerSupport/ShortcutFunction';
import IndexQuestionCategoryCards from '../../components/includes/customerSupport/IndexQuestionCategoryCards';
        ...
        <Layout>
            ...
            <Content className="layoutContent">
                ...
                <div className="qaBlockTitle">
                    ...
                    <a href="/newweb/customer-support/questions">
                        完整問題
                        <RightOutlined />
                    </a>
                </div>
